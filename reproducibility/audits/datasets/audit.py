...
def make_report(result: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            ...
            "3. **Feedback-loop snapshot nije moguće tačno reloadati iz samog paketa.** `base_time` i lookback su sačuvani, ali izvorno ime profila, sjeme i shard count nisu [reproducibility/dataset-catalog.csv:2 i reproducibility/README.md:63-70]. To ne poništava before/after nalaz na istom snapshotu, ali ograničava bit-for-bit reprodukciju dataseta.",
