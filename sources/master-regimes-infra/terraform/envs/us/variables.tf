...
variable "region_code" {
  description = "Vultr region code for the US deployment."
  type        = string
  default     = "ewr"
}

variable "existing_vpc_id" {
  description = "Optional existing Vultr VPC ID. Set this to the EU anchor VPC ID for shared-VPC logical US runs."
  type        = string
  default     = ""
}

variable "existing_vpc_cidr" {
  description = "CIDR for existing_vpc_id. Set this to the EU anchor VPC CIDR for shared-VPC logical US runs."
  type        = string
  default     = ""
}
